...
def analyze_workflow(workflow_name, mode):
    ...
    while j < 16:
        ...
        print(f'{workflow_name} e2e_latency:',e2e_latency)
    if times != 0:
        e2e_dict[workflow_name]  = total_e2e_latency / times
    else:
        e2e_dict[workflow_name] = 'timeout'
...
def analyze(mode, datamode):
    ...
    #workflow_pool = ['cycles', 'epigenomics',  'soykb',  'fileprocessing', 'wordcount','genome']
    #workflow_pool = ['fileprocessing']
    #workflow_pool = [ 'wordcount','fileprocessing']
    #workflow_pool = ['soykb']

...
# ax1.ba#r(x+3*bar_width, dflow_corun, bar_width, color="grey", align="center", label="DFlow co-run",edgecolor='black',linewidth=2)
...
# ax2.plot(x,ideal_degrade, color="grey",linewidth=3,label='DFlow degradation',marker='o', ms=12)
ax2.set_ylim(0,4)
